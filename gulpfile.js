...
const paths = {
    html:['header.html'],
    css:['./src/scss/vars.scss', './src/scss/common.scss', './src/scss/header.scss', './src/scss/main-page.scss', './src/scss/footer.scss', './src/scss/catalogue.scss', './src/scss/good-page.scss','./src/scss/contacts.scss'],
