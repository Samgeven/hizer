...
const paths = {
    html:['header.html'],
    css:['./src/scss/vars.scss', './src/scss/common.scss', './src/scss/header.scss', './src/scss/main-page.scss', './src/scss/footer.scss', './src/scss/catalogue.scss', './src/scss/good-page.scss','./src/scss/contacts.scss', './src/scss/dealer-page.scss', './src/scss/history.scss'],
    ...
    js:['./src/js/main.js', './src/js/slider.js', './src/js/gallery.js', './src/js/popup.js', './src/js/sort.js', './src/js/forms.js']
  };
